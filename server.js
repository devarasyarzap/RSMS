...
const masterRoutes = require('./src/routes/masterRoutes'); // Route Poli & Dokter
const registrationRoutes = require('./src/routes/registrationRoutes'); // Route Pendaftaran
const doctorRoutes = require('./src/routes/doctorRoutes'); // Route Pemeriksaan
const pharmacyRoutes = require('./src/routes/pharmacyRoutes'); // Route Apotek
